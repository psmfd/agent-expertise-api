...
**Implementation progress: 6/8 controls fully implemented (C1, C4, C5, C8 via #167; C6, C7 via #168); 1/8 partial (C2 via #12); 1/8 not started (C3 future write-tool work).**
