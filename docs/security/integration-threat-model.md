...
**Implementation progress: 7/8 controls fully or substantially implemented (C1, C4, C5, C8 via #167; C6, C7 via #168; C3 via #188 — soft-require, hard-require flip pending #205 + #206); 1/8 partial (C2 via #12).**
